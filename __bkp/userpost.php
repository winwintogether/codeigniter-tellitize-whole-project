								...
								$location=$row['location'];
								 ...
								 $category='';
									...
									$share_btncode='<div class="addthis_toolbox addthis_default_style " >
										  ...
										  addthis:title="'.$category_link.','.$commentonpost.'"  addthis:description=" '.$commentonpost.'">share</a>
								</div>';
									...
									$html.='<div id="email-btns">
											   <div class="orang_mid_anonymous" '.$anony_clickfn.'></div>
											   <div class="orang_mid_email" style="float:right" '.$clickfn.'></div>
											 </div>';
							$html.='</div> ';			
									}
