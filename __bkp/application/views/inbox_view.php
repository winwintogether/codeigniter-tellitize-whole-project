	...
	<div id="mid_container">
		<div class="mid_content">
			<div id="left_msg" style="float:left;margin-left:2px;margin-right:5px;margin-top:80px;width:215px;" >
									  ...
									  <ul>
									  	<li class="inbox"><a href="<?php echo $GLOBALS['base_url']; ?>inbox">Inbox</a></li>
			...
			<div class="top_bar" style="margin-top:1px;margin-bottom:1px;">
							<div class="mypost_icon" style="float:left;margin-left:5px;"><span style="position:relative;top:10px;"><img width="27" height="32" alt="message" src="../images/message-top-icon.png"></span>
							<span style="font:14px arial;font-weight:normal;color:#666666;padding-top:-10px;">VIEW MESSAGE</span>
							</div>
				...
				<div id="post_contents" style="width:467px;" >
		          <ul class="pagination1">
						...
						<?php
						$selectQuery=mysql_query("SELECT * from messages where to_user='".$_SESSION['userid']."' order by id desc");
						...
						$query = mysql_query("SELECT profile_img,name,last_name from users where userid='".$row['from']."'");
						 ...
						 <div style="float:left;font:12px arial;padding-left:5px;width:80%;height:80%;overflow:hidden">
						 	<h4 class="orange">
								<a href="<?php echo $GLOBALS['base_url']; ?>view-profile/<?php echo $name_link; ?>/<?php echo $row['from']; ?>">
									<?php  $username=$this->home_model->getUsername($row['from']); echo $username;?>
								</a>
							</h4>
							<div class="message_body" id="message_body<?php echo $row['id'];?>"><h5><?php echo $row['message'];?> </h5></div>
							<div class="message_body_full" id="message_body_full<?php echo $row['id'];?>">
								<h5><?php echo $row['message'];?> </h5>
								<h4 class="orange" style="float:right;margin:0px 0px 0px 20px;padding-right:0px;">
									<a href="<?php echo $GLOBALS['base_url']; ?>message?replyid=<?php echo $row['from']; ?>">Reply</a>
								</h4>
