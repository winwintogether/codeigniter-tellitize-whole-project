    ...
    <body>
        ...
        <script type="text/javascript">
            window.fbAsyncInit = function() {
                FB.init({appId: '193323994134869', status: true, cookie: true, xfbml: true});
        ...
        alert("Logged in.. Redirecting you now...");
         window.location = "http://118.94.177.106:8165";
                ...
                /*FB.Event.subscribe('auth.logout', function(response) {alert("2")
                    // do something with response
                    logout();
                });*/

                FB.getLoginStatus(function(response) {alert("3")
                    if (response.session) {
        ...
        <p><fb:login-button autologoutlink="true" perms="email,user_birthday,status_update,publish_stream,user_about_me" show-faces="true"></fb:login-button>
