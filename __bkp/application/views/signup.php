						...
						<div class="myprofile">
						 ...
						 <div class="signUp">
						 		...
						 		<?php echo validation_errors();
								  echo form_open('reg',array('name' => 'register' ,'id'=>'register')); 
								 ?>
						  		<div id="left-main">
						  		...
						  		<div id="right-main">
										<ul>												
												<li>
													<h1>First Name</h1>
													<h2><input type="text" name="first_name" value="" id="first_name" class="input_txt"/></h2>				
												</li>
												<li>
													<h1>Last Name</h1>
													<h2><input type="text" name="last_name" value="" id="last_name" class="input_txt"/></h2>				
												</li>
												<li>
													<h1>Email</h1>
													<h2><input type="text" name="email" value="" id="email" class="input_txt"/></h2>				
												</li>
												<li>
													<h1>Username</h1>
													<h2><input type="text" name="username" value="" id="username" class="input_txt"/></h2>				
												</li>
												
												<li>
													<h1>password</h1>
													<h2><input type="password" name="password" value="" id="password" class="input_txt"/></h2>				
												</li>
												<li>
													<h1>Confirm Password</h1>
													<h2><input type="password" name="passconf" value="" id="passwordConfirm" class="input_txt"/></h2>				
												</li>
                                       <li class="tos_content">
            ...
            <li>Acceptance of Terms.</li>
                ...
                <ol> </ol>
												...
												<li>
													...
													<input type="checkbox" name="agree" value="" id="agree" /> I have read and agree to the Terms of Service
													</h1>			
												</li>
                           
											
												<li id="signup">
													<img width="138" height="33" alt="sign-up-account" 
													src="<?php echo $GLOBALS['base_url']; ?>images/sign-up-btn.jpg" onClick="validate_signUp_form();">				
												</li>
