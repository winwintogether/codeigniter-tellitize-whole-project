...
<div class="post_main" id="post_main_group" style="display:none">
							...
							<div class="post_main_content">
								...
								<input type="hidden" name="place" id="place_id" value="<?php echo $placeid;?>">
								 ...
								 <div  class="top_from" style="width:92%;margin-left:2%;margin-bottom:3px;">
								...
								onClick="<?php if(isset($_SESSION['username'])){ ?>validateGroupPostComment()<?php }else { ?>notValid()<?php }  ?>;">
								</a>
								</div>
								<div style="margin-left:3px;" class="postTopBox"><div class="postTop-title">SELECT CATEGORY: </div>
