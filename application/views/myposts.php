...
$(".deletepost").hover(function(){ alert('hi');
		          ...
		          <ul class="pagination1">
					...
					$html='';
						...
						$comment_posted= $this->home_model->autolink($row['comment']);
									$html.='<li id="list_'.$row['postid'].'"><div id="article">
														<div class="post_user-main delete_post_div" id="delete_post_'.$row['postid'].'" onmouseover="showDeletePost('.$row['postid'].');" onmouseout="hideDeletePost('.$row['postid'].');">
															...
															<div class="userpost-name">
															 ...
															 <div class="deletepost">
															 	<div class="delete-post'.$row['postid'].'" id="delete-post" onclick="deleteMyPost('.$row['postid'].')" style="margin-top:7px;"> 
