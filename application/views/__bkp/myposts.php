				...
				<div id="post_contents" >
		          <ul class="pagination1">
					...
					$html='';
							...
							$select=mysql_query("SELECT * FROM public_post where userid =".$_SESSION['userid']."  and status=0 order by  postid desc");
						...
						$postuser_img='';
								...
								$postuserPic='<img  src="../images/user-photo.jpg" width="39" height="42" alt="user-img-small" class="bdr"/>';
								}
						...
						$comment_posted= $this->home_model->autolink($row['comment']);
									$html.='<li id="list_'.$row['postid'].'"><div id="article">
														<div class="post_user-main"  onmouseover="showDeletePost('.$row['postid'].');" onmouseout="hideDeletePost('.$row['postid'].');">
															...
															<div class="userpost-name">
															 ...
															 <div class="deletepost"><div class="delete-post'.$row['postid'].'" id="delete-post" onclick="deleteMyPost('.$row['postid'].')"> 
																<img src="'.$GLOBALS['base_url'].'images/close-btn.jpg" width="15" height="15" alt="delete" title="delete"></a></div>
															</div>
															 <div class="userpost-city">Posted: '.$date.','.$location.'</div>
														 </div>
																 ...
																 <div class="postcontent">
																  ...
																  <div class="postcontent-aggre-main">
																		...
																		$html.= ' <div  class="disagree-btn" id="btnd'.$row['postid'].'">
																		  ...
																		  $html.='<div class="share"><a href="javascript:void(0)">share</a></div>';*/
															  $html.=' </div>
														</div>
													</div>';
										...
										{ $html.='<div class="view_all view_all'.$row['postid'].'"><a href="javascript:void(0)" onclick="viewreplies('.$row['postid'].');">View all '.$count.' comments</a></div>';}else{
										 ...
										 $selectreplies=mysql_query("SELECT * from post_replies where  postid='".$row['postid']."' order by id desc limit 5 ");
											...
											while($row1=mysql_fetch_array($selectreplies)){											
												...
												$disagree_link=' <a onclick="disagreeReply('.$row1['id'].');"  href="javascript:void(0);">Disagree </a>';
