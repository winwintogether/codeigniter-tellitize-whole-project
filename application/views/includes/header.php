...
<script>(function(d, s, id) {
  ...
  js.src = "//connect.facebook.net/en_US/all.js#xfbml=1&appId=403489746398321";
...
<div id="headwrap">
	...
	<div id="rightmain">
		...
		<div class="right-top-main">
			...
			<a href="#">
			<div id="login">
		 	<img width="75" height="27" alt="login-btn" src="<?php echo $GLOBALS['base_url']; ?>/images/login-btn.png"  onclick="verifyLogin();" id="log">
			</div>
			</a>
			</div>
            <div class="social_login">
                ...
                <img width="28" height="28" alt="facebook-icon" src="<?php echo $GLOBALS['base_url']; ?>/images/facebook_icon.png" style="margin-top:8px;">
                </a>
                </div>
                <div class="twitter">
                 <a href="<?php echo $GLOBALS['base_url']; ?>?login&oauth_provider=twitter">
                <img width="28" height="28" alt="twitter-icon" src="<?php echo $GLOBALS['base_url']; ?>/images/twitter_icon.png" style="margin-top:8px;">
                </a>
                </div>
            </div>
...
<?php }
	...
	<div id="rit_pic">
		...
		<ul class="menus">
			<li class="menu1"><a href="<?php echo $GLOBALS['base_url']; ?>myposts">MY POST</a><span class="circle" id="my_post_span"><?php if(isset($postcount)) echo $postcount;?></span></li>
			<li class="menu2"><a href="<?php echo $GLOBALS['base_url']; ?>myprofile">My profile</a></li>
			<li class="menu3"><a href="<?php echo $GLOBALS['base_url']; ?>notifications"> notification</a><span class="circle" id="notification_span"><?php if(isset($notification_count)) echo $notification_count;?></span></li>
			<li class="menu4"><a href="<?php echo $GLOBALS['base_url']; ?>message">Messages</a><span class="circle" id="message_span"><?php if(isset($messages_count)) echo $messages_count;?></span></li>
...
?>
	...
	<div id="menu-main">
		...
		<div class="menu-inner-main">
				<div class="search_txt style1" style="padding-bottom:1px;"><strong>Search to see if you have been Tellitized</strong>
				...
				<div class="Navigation-main">
				   <form name="search" action="<?php echo $GLOBALS['base_url'];?>search" id="search-form" method="GET">
					...
					<div class="navi-input-boxes">
					<input class="input2" type="text" value="EMPLOYER" name="s_nick_name" onfocus="if(this.value  == 'EMPLOYER') { this.value = ''; } " 
									onblur="if(this.value == '') { this.value = 'EMPLOYER'; } " id="s_nick_name">
					</div>
					...
					<input class="input2" type="text" value="HIGH SCHOOL" name="s_pods" onfocus="if(this.value  == 'HIGH SCHOOL') { this.value = ''; } " 
									onblur="if(this.value == '') { this.value = 'HIGH SCHOOL'; } " id="s_pods">
					</div>
            ...
            <div class="faqs" style="margin-top:17px;"><a href="<?php echo $GLOBALS['base_url']; ?>faq" class="faqs_link"></a></div>
	</div><!--menu-inner-main-->
