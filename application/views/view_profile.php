				...
				<div id="myprofile">
						<div class="myprofile">
								...
								<ul id="invite_btns">
									...
									<li><a href="<?php echo $GLOBALS['base_url']; ?>add-to-group/<?php echo $profileid;?>">Invite <?php echo stripslashes($name);?> to Group</a></li>
									<li><a href="<?php echo $GLOBALS['base_url']; ?>add-to-discussion/<?php echo $profileid;?>">Invite <?php echo stripslashes($name);?> to POD</a></li>
								</ul>
											...
											<div id="profile_container" style="border:none">
														...
														<div id="right-main">
																...
																<ul>
																	...
																	<li>
																		<h1>Name</h1>
																		<h2><input type="text" name="name_view" value="<?php echo stripslashes($name);?>"  
																	...
																	<!--<li>
																		...
																		<li>
																			<h1>Email</h1>
																			<h2><input type="password" name="email_view" value="<?php echo $email;?>"  
