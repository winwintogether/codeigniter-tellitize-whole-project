									...
									if($p_row=mysql_fetch_array($query)){
									   {
										...
										if($profile_img!='') 
										{
											$profilPic='<img  alt="user photo" width="39" height="42" alt="user-img-small" class="bdr" src="'.$GLOBALS['base_url'].'/ajax/uploads/'.$profile_img.'" />';
										}
																 ...
																 <div class="postcontent">
																  ...
																  <div class="postcontent-aggre-main">
																		...
																		if($agreed==''){
																			...
																			$html.= '<div style="float:left; margin:0 10px 0 0;" class="orangeButton agree_'.$row['postid'].'">
																						<input type="button" value="agree" id="agreebtn'.$row['postid'].'" class="orangeButton-right" ' .$agreeClick.' >
																					 </div>';
																   
																		}
																		else {
																		 	//$html.='<div  class="agree-btn "  id="btn'.$row['postid'].'">'.$agreed.' </div>'; 
																			$html.='<div style="float:left; margin:0 10px 0 0;" class="disableButton agree_'.$row['postid'].'">
																						<input type="button" value="agree" class="disableButton-right" id="btn'.$row['postid'].'">
																					</div>';
																		}
																		...
																		if($disagreed==''){
																			...
																			$html.='<div style="float:left; margin:0 10px 0 0;" class="orangeButton disagree_'.$row['postid'].'">
																						<input type="button" value="disagree" id="disagreebtn'.$row['postid'].'" class="orangeButton-right" ' .$disagreeClick.' >
																					 </div>';
																		}
																		else {
																		 //	$html.='<div  class="disagree-btn" id="btnd'.$row['postid'].'">'.$disagreed.' </div>'; 
																			$html.='<div style="float:left; margin:0 10px 0 0;" class="disableButton disagree_'.$row['postid'].'">
																						<input type="button" value="disagree" class="disableButton-right" id="btn'.$row['postid'].'">
																					</div>';
																		}
										...
										{ $html.='<div class="view_all view_all'.$row['postid'].'"><a href="javascript:void(0)" onclick="viewreplies('.$row['postid'].');">View all '.$count.' comments</a></div>';}else{
										 ...
										 $selectreplies=mysql_query("SELECT * from post_replies where  postid='".$row['postid']."' order by id desc limit 5 ");
											...
											while($row1=mysql_fetch_array($selectreplies)){											
												...
												//if replies 
												//$agree_link=' <a onclick="agreeReply('.$row1['id'].');" href="javascript:void(0);" >Agrees </a>';
									  ...
									  //reply comment	
										$html.='<div id="replyComment">
												...
												<textarea class="input-tetlize commentreplyArea" name="commentreplyArea" id="commentreplyArea'.$row['postid'].'"></textarea>
													...
													<div class="orangeButton" style="float:right;margin:3px 11px 2px 0px;">
														<input type="button" name="comment" value="Comment" onclick="postReply('.$row['postid'].');" class="orangeButton-right">
													</div>
												</form>	
													</div>		'; //<div class="orangeButton" style="float:right;margin:-18px 2px 2px 0px;"><input type="button" name="comment" value="Comment" onclick="postReply('.$row['postid'].');" class="orangeButton-right"></div>
										}$html.='</li>';				
									}
