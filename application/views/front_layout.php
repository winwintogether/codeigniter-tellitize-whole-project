...
<head>
	...
	<title><?php echo $title;?> | Tellitize	 </title>
...
<body>
	...
	<div id="header"><?=isset($content_for_layout_header)?$content_for_layout_header:'';?></div>
	
	<?=isset($content_for_layout_middle)?$content_for_layout_middle:'';?>   
	
	<div id="footer"><?=isset($content_for_layout_footer)?$content_for_layout_footer:'';?></div>
...
function postReply(id){ 
	...
	dataString='postid='+id+'&comment='+comment+'&anonymous_user='+anonymous_user;
	$.ajax({
			type: "POST",
 ...
 function agreeReply(id){
				...
				if(data.success == "yes")
			  	{
					...
					$('.disagree_'+id).attr('class', 'orangeButton disagree_'+id);
					$('.disagree_'+id).html("");
					$('.disagree_'+id).html("<input type='button' value='disagree' class='orangeButton-right' onclick='disagreeReply("+id+");' >");
	 ...
	 function disagreeReply(id){ //alert('Disagree');
			...
			if(data.success == "yes")
			{
				...
				$('.agree_'+id).attr('class', 'orangeButton agree_'+id);
				$('.agree_'+id).html("");
				$('.agree_'+id).html("<input type='button' value='agree' class='orangeButton-right' onclick='agreeReply("+id+");'>");
