		...
		<div class="mid_content">
			...
			<div class="post_area_bg" style="padding-top:0px;">
				...
				<div id="post_contents" >
				  ...
				  else if($_GET['s_pods']!='' && $_GET['s_pods']!='HIGH SCHOOL') $searh_common=2;
				  else  $searh_common=0;
				  ...
				  if($searh_common==0)
				  {
					...
					{
						$selectSearch.=" AND first_name LIKE '%".$_GET['s_first_name']."%' OR last_name LIKE '%".$_GET['s_first_name']."%' OR place LIKE '%".$_GET['s_first_name']."%' OR other_description LIKE '%".$_GET['s_first_name']."%'";
					...
					{
						$selectSearch.=" AND first_name LIKE '%".$_GET['s_last_name']."%' OR last_name LIKE '%".$_GET['s_last_name']."%' OR place LIKE '%".$_GET['s_last_name']."%' OR other_description LIKE '%".$_GET['s_last_name']."%'";
						$search.=" AND last_name LIKE '".$_GET['s_last_name']."%'";
						$scanComment.=" OR comment LIKE '%".$_GET['s_last_name']."%'";
					}
					 
					if(isset($_GET['s_location']) && $_GET['s_location']!='' && $_GET['s_location']!='LOCATION'){
						$selectSearch.="AND place LIKE '%".$_GET['s_location']."%'";
						$search.=" AND city LIKE '%".$_GET['s_location']."%'";
						$scanComment.=" OR comment LIKE '%".$_GET['s_location']."%'";
					}
					
					if(isset($_GET['s_age']) && $_GET['s_age']!='' && $_GET['s_age']!='AGE'){
						$selectSearch.="AND other_description LIKE '%".$_GET['s_age']."%'";
						$search.=" AND age = '".$_GET['s_age']."'";
						$scanComment.=" OR comment LIKE '%".$_GET['s_age']."%'";
					}
					   
					/*if(isset($_GET['s_nick_name']) && $_GET['s_nick_name']!='' && $_GET['s_nick_name']!='EMPLOYER'){ echo "<><>hiii";
						$search.=" AND  nickname LIKE '%".$_GET['s_nick_name']."%'";
						$scanComment.=" OR comment LIKE '%".$_GET['s_nick_name']."%'";
					}*/
					
					if($_GET['s_nick_name'] != "EMPLOYER")
					{ 
						$search.=" AND  nickname LIKE '%".$_GET['s_nick_name']."%'";
						$scanComment.=" OR comment LIKE '%".$_GET['s_nick_name']."%'";
					}
					...
					if($search!=''){
					 ...
					 $selectQuery=" SELECT * FROM public_post  where status=0 ".$selectSearch." ".$search." ".$scanComment." order by postid desc ";
					 //echo $selectQuery;
					  }
					  else{
					        if($searh_common==1){
