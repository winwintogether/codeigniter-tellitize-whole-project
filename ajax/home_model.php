...
class Home_model extends CI_Model{
  ...
  function login($username, $password)
	...
	function article(){
		...
		$query = $this->db->query("SELECT * FROM public_post order by  postid desc limit 10");
		}
					     ...
					     <div id="article">
									<div class="post_user-main">
										...
										<div class="userpost-name">
											 <div class="userpost-title"><a href="'.$GLOBALS['base_url'].'index.php/userpost?postid='.$row['postid'].'">'.$category.'</a></div>
	...
	function getAllPlace(){
	  	$html='';
		$query = $this->db->query("SELECT id,place from place_of_discussion");
